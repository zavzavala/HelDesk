            ...
            <div class="card">
              ...
              <div class="card-body">
                <div style="overflow-x:auto;">
                  <table class="table table-hover table-condensed" id="membro-table">
                    <thead>
                    <tr>
...
<div class="modal fade editMembro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
