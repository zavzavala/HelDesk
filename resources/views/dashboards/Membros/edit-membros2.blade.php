...
@section('content')
    ...
    <form action="{{ route('update-membro') }}" method="POST" id="edit-membro">
        @csrf
        <input type="hidden" name="id_membro" value="{{$membro->id}}">
        <div class="row">
            <div class="col-md-6">
                <label>Nome *</label>
                <input type="text" name="nome" value="{{$membro->nome}}" class="form-control" >
                <span class="text-danger error-text nome_error"></span>

            </div>
            <div class="col-md-6">
                <label>Apelido *</label>
                <input type="text" name="apelido" value="{{$membro->apelido}}" class="form-control" >
